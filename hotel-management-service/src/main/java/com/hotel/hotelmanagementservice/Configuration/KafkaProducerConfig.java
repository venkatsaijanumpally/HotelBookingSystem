...
import com.hotel.hotelmanagementservice.Service.Test;
...
public class KafkaProducerConfig {
    ...
    @Bean
    public KafkaTemplate<String, Hotel> hotelKafkaTemplate() {
        return new KafkaTemplate<>(producerFactory());
    }

    @Bean
    public ProducerFactory<String, Test> producerTestFactory() {
        Map<String, Object> configProps = new HashMap<>();
        configProps.put(
                ProducerConfig.BOOTSTRAP_SERVERS_CONFIG,
                bootstrapAddress);
    ...
    @Bean
    public KafkaTemplate<String, Test> hotelTestTemplate() {
