 ...
 */
public class BookingReferenceIDGenerator {
    ...
    private static BookingReferenceIDGenerator instance;

    private BookingReferenceIDGenerator() {
    ...
    public synchronized static BookingReferenceIDGenerator getInstance() {
        if (instance == null) {
            instance = new BookingReferenceIDGenerator();
        }
        return instance;
    }
